...
from book_giveaway.models import AskForBookRequest, RequestStatus
    ...
    **Conditions**:
    ...
    def put(self, request, *args, **kwargs):
        ...
        if instance.book.owner == request.user and instance.book.is_available:
            instance.status = RequestStatus.ACCEPTED.value
...
class DeclineBookRequestView(generics.UpdateAPIView):
    """
    ...
    **Conditions**:
    ...
    def put(self, request, *args, **kwargs):
        ...
        if instance.book.owner == request.user:
            instance.status = RequestStatus.DECLINED.value
            instance.save()
...
class UserSentRequestsListView(generics.ListAPIView):
    """
    ...
    **Permissions**:
    ...
    def get_queryset(self):
        return AskForBookRequest.objects.filter(requester=self.request.user)
